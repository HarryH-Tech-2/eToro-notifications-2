...
PROFILE_URLS: list[str] = [
    ...
    "https://www.etoro.com/people/robchamow",
    "https://www.etoro.com/people/sburada",
]
...
def _build_message(username: str, post_url: str) -> str:
    """Compose the WhatsApp notification body: just who and where."""
    return f"@{username} posted: {post_url}"
...
def _process_profile(profile_url: str, phone: str, apikey: str) -> None:
    ...
    for post in reversed(to_notify):
        message = _build_message(username, post.url)
        try:
